...
async function main() {
	...
	try {
		...
		try {
			...
			let prikey2 = await contract.submitTransaction("Gen_EA_KeyPair","EsPublicKey02", kem_algorithm_name);
			console.log(prikey2.toString());
			fs.writeFileSync("prikey2.txt",prikey2);
			console.log('*** prikey2: committed');
